...
class Circle implements IShape {
  ...
  boolean equals(Circle c) {
    return c.center.equals(this.center) && this.radius == c.radius && this.color.equals(c.color);
  }
}
...
class Square implements IShape {
  ...
  boolean equals(Square s) {
    return s.nw.equals(this.nw) && this.size == s.size && this.color.equals(s.color);
  }
}
...
class CartPt {
  ...
  boolean equals(CartPt cp) {
    return cp.x == this.x && this.y == cp.y;
  }
}
